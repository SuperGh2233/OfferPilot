...
- 当前任务：**漏训日补排已上线**。2026-09-18 已应用 `202609170001_knowledge_ai_scoring.sql`，迁移记录与新增字段验证通过；代码已推送 `main`（`02722d0`），Vercel 部署成功，稳定域名匿名 Smoke 通过。下一项回到优化路线优先级 2（120 道核心八股题匹配质量）。
